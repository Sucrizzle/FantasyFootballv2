...
FROM read_parquet('BUCKET_PLACEHOLDER/gold/facts/fact_team_stats_weekly.parquet', union_by_name = true) ftsw
join read_parquet('BUCKET_PLACEHOLDER/gold/dimensions/dim_schedule.parquet', union_by_name = true) ds
